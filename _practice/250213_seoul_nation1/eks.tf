module "eks" {
  ...
  eks_managed_node_groups = {
    "${var.project_name}-addon-nodegroup" = {
      name = "${var.project_name}-addon-nodegroup"
      ami_type       = "BOTTLEROCKET_ARM_64"
      instance_types = ["t4g.medium"]
      iam_role_name  = "${var.project_name}-addon-nodegroup"
    ...
    "${var.project_name}-app-nodegroup" = {
      name = "${var.project_name}-app-nodegroup"
      ami_type       = "BOTTLEROCKET_x86_64"
      instance_types = ["t3.small"]
      iam_role_name  = "${var.project_name}-app-nodegroup"
...
output "fargate_profile_execution_role_arn" {
