locals {
  ...
  eks_discovery_tag = "$1-prod-cluster"
  ...
  subnets = [
    {
      ...
      name     = "$1-prod-peering-sn-$2"
      rtb_name = "$1-rtb-prod-peering"
      cidr_pattern = {
        start_index     = 1
        step_per_subnet = 1
      }
    },
    {
      ...
      name     = "$1-prod-workload-$2"
      rtb_name = "$1-rtb-workload-$2"
      cidr_pattern = {
        start_index     = 10
        step_per_subnet = 1
      }
    },
    {
      ...
      name     = "$1-prod-protect-sn-$2"
      rtb_name = "$1-rtb-protect"
      cidr_pattern = {
        start_index     = 20
        step_per_subnet = 1
      }
