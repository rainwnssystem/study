...
provider "registry.terraform.io/cloudposse/awsutils" {
  ...
  constraints = ">= 0.16.0"
  hashes = [
    "h1:Ge/LwswQ+hzdgjMNk6bKggy3aeI1VB+zuWMsCClW5gg=",
    "h1:QDh6MOUcbeRjAab15+r9pPbpx2eehaoGJRT5A/MrnZE=",
...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "5.88.0"
  constraints = ">= 2.0.0, >= 3.0.0, >= 4.0.0, >= 4.33.0, >= 4.36.0, >= 4.47.0, >= 5.0.0, >= 5.30.0, >= 5.83.0"
  hashes = [
