...
#   name = "${var.project_name}-policy-amp"
...
# module "amp" {
#   source    = "terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks"
#   role_name = "${var.project_name}-role-amp"

#   role_policy_arns = {
#     policy = aws_iam_policy.amp.arn
#   }
...
#       provider_arn               = module.eks.oidc_provider_arn
#       namespace_service_accounts = [
#         "monitoring:amp-iamproxy-ingest-service-account"
#       ]
#     }
#   }
# }

# resource "kubernetes_service_account" "amp" {
#   metadata {
#     name      = "amp-iamproxy-ingest-service-account"
#     namespace = "monitoring"
#     annotations = {
#       "eks.amazonaws.com/role-arn" = module.amp.iam_role_arn
#     }
#   }
# }